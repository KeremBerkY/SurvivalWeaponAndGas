...
#include "ProjectileWeaponSwitchAbility.generated.h"

/**
 * 
 */
UCLASS()
class SURVIVAL_API UProjectileWeaponSwitchAbility : public UCharacterGameplayAbility
{
	GENERATED_BODY()

protected:
	UProjectileWeaponSwitchAbility();
